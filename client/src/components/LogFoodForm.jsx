...
export default function LogFoodForm({ onLogCalories }){
  ...
  return (
    <form className="bg-white p-4 rounded-lg shadow-md" onSubmit={handleSubmit}>
      ...
      <div className="mb-4">
        ...
        <div>
          <label className="block text-gray-700 font-semibold">Proteins (g)</label>
          <input
            type="number"
            value={proteins}
        ...
        <div>
          <label className="block text-gray-700 font-semibold">Carbohydrates (g)</label>
          <input
            type="number"
            value={carbohydrates}
