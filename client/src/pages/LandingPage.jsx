...
import appleImage from "../assets/banana.png"; // Replace with your phone image
import bananaImage from "../assets/apple.png"; // Replace with your phone image
                ...
                <div className="flex items-center justify-between">
                    <div className="w-1/2">
                        ...
                        <p className="text-xl text-green-600 mb-8">
                            Count calories, track macros, and achieve your fitness goals
                            with CalorieWise.
                        </p>
                        <Link to="/dashboard">
